...
#Region "Exported"
    ...
    End Function
    Public Function NextSection(dialog As IDialogResource, app As AppService, disk As DiskService, settings As SettingsService) As MediaSection
        Select Case Me.CurrentSection
            Case MediaSection.Regular
                Return If(app.GetPeriod(dialog, disk, settings) = Period.Day, MediaSection.Alternate, MediaSection.Night)
            Case MediaSection.Alternate
                Return If(app.GetPeriod(dialog, disk, settings) = Period.Day, MediaSection.Regular, MediaSection.Night)
        End Select
